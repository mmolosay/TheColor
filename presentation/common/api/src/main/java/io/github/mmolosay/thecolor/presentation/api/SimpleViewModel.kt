 ...
 *
 * This component has nothing to do with Google's implementation of `ViewModel`.
 ...
 * implementation.
 *
 * @param coroutineScope a scope to be used inside this `ViewModel`.
 * Cancelled in [dispose()][dispose].
